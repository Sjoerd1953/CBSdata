...
# Bepaal het hoogste weeknummer voor 2020
df_2020 = df_weekdata[
...
# Kolom met cumulatief aantal overledenen toevoegen. Groeperen per jaar
df_graph_65min['Overledenen_cum'] = df_graph_65min.groupby(['Jaar'])['Overledenen'].cumsum(axis=0)
df_graph_65tot80['Overledenen_cum'] = df_graph_65tot80.groupby(['Jaar'])['Overledenen'].cumsum(axis=0)
df_graph_80plus['Overledenen_cum'] = df_graph_80plus.groupby(['Jaar'])['Overledenen'].cumsum(axis=0)
...
pivot_65min = df_graph_65min[(df_graph_65min['Jaar'].isin(jaren))].pivot('Week', 'Jaar', 'Overledenen_cum')
pivot_65tot80 = df_graph_65tot80[(df_graph_65tot80['Jaar'].isin(jaren))].pivot('Week', 'Jaar', 'Overledenen_cum')
pivot_80plus = df_graph_80plus[(df_graph_80plus['Jaar'].isin(jaren))].pivot('Week', 'Jaar', 'Overledenen_cum')
